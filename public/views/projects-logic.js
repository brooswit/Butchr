...
//
// DOM-free OUTRIGHT, not merely at module load: zero imports, and nothing here touches `document`
// even when called. test/projects-initiatives-ui.test.ts and the pure half of
...
// says so) — so they come across too. `ceoNote` returns a NODE and stays in views/projects.js.
...
// "CEO disabled". Returns { cls, label, title? }.
