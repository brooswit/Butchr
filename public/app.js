...
// renderTask calls into it. setPendingInlineRestore is the SSE path's one write into its state:
// an imported `let` cannot be assigned, so the owning module exports a setter instead.
import { renderMetrics } from "./views/metrics.js";
import {
  composeReviewNote,
  renderDiff,
  setPendingInlineRestore,
  wireDiff,
} from "./views/diff.js";
