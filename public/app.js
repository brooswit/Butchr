...
// project-modals.js owns the three PROJECTS dialogs (create project / launch initiative / add
// workspace) — extracted whole, with the localStorage `rememberCreatedProject` fallback that only
// the create modal ever used. openPicker is no longer imported HERE: the add-workspace modal was
// its only caller in this file, and it now imports it from overlay.js directly.
